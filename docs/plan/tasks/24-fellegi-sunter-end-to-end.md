...
- [ ] Incomplete evidence from a cost-tier short-circuit produces an unscorable result that the resolver surfaces rather than scoring partially, asserted through a resolve rather than through the scorer alone.
